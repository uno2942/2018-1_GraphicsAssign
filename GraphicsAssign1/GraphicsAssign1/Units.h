...
const Vector3 INITIAL_PLAYER_BOX_POSITION = Vector3(WORLD_COORD_MAP_XLEN/2, WORLD_COORD_MAP_ZLEN - 300, 282.6852112 /2); //WORLDCOORDWINDOWWIDTH/16(100, 0)
const Vector3 INITIAL_ENEMY_BOX_POSITION = Vector3(WORLD_COORD_MAP_XLEN / 2, 300, 282.6852112 /2);
